...
export class ProfilePage implements OnInit {
  ...
  async createTrackOder(item) {
    ...
    const modal = await this.modalController.create({
      ...
      componentProps: { ref: item.ref,name: item.info.product[0].prod.product_name,price: item.info.product[0].prod.price,amount: item.info.product[0].prod.amount,quantity: item.info.product[0].prod.quantity,image: item.info.product[0].prod.image,productCode: item.info.product[0].productCode,desc: item.info.product[0].desc,
